...
def clean_text(text: str) -> str:
    ...
    stop_words = ["flight", "flights", "tickets", "ticket", "bookings", "booking", "trip", 
    "travel", "plan", "complete", "day", "days", "hotels", "including", "budget", "info", 
    "information", "journey", "sightseeing", "places"]
